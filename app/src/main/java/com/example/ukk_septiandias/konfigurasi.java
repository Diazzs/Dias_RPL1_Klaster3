package com.example.ukk_septiandias;

public class konfigurasi {
    //Pemangilan Tambah KERIPIK
    public static final String URL_ADD =
            "http://192.168.1.10/keripik/datakeripik/tambahkeripik.php";

    //Tampil keripik
    public static final String URL_GET_ALL =
            "http://192.168.1.10/keripik/datakeripik/tampilkeripik.php";
    public static final String URL_GET_EMP =
            "http://192.168.1.10/keripik/datakeripik/detailkeripik.php?id_keripik=";
    //update databarang
    public static final String URL_UPDATE_EMP =
            "http://192.168.1.10/keripik/datakeripik/penjualankeripik.php=";
    //Hapus databarang
    public static final String URL_DELETE_EMP =
            "http://192.168.1.10/keripik/datakeripik/hapuskeripik.php?id_barang=";

    public static final String
            //Pemangilan Tambah KERIPIK
            URL_ADDJUALAN = "http://192.168.1.10/keripik/datakeripik/penjualankeripik.php";
    //Tampil Barang
